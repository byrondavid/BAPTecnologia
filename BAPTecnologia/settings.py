"""
Django settings for BAPTecnologia project.
...
SECRET_KEY = 'u-qbo-(63vhc7tcl)#=$$!whnzex2g%67kc_uq7rxh##w@dq$1'
...
INSTALLED_APPS = [
    ...
    'core',
    'django_cleanup',
    # siver para eliminar las imaganes o archivos que no se usan
    'corsheaders',  # permite el trafico entre plataformas
    'rest_framework',  # es un framerok que sirve para desarollar APIS
    'django_filters',
    # es un complemento para django res_framework, para manejar mejor los filtros
    'storages',
    # es un complemento para poder subir los archivos directo a AWS S3
]
...
WSGI_APPLICATION = 'BAPTecnologia.wsgi.application'
